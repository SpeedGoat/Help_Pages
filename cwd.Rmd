...
Click the *Download Report* button to generate an html report of your data. The report includes all of the test and sample data you entered, the settings used, and the output tables and plots.
